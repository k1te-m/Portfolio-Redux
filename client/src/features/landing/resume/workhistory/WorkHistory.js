    ...
    <>
      ...
      <div className="card mb-1">
        ...
        <ul className="list-group list-group-flush">
          ...
          <li className="list-group-item">
            Organize the work of the team, assign tasks, monitor all activities,
            and ensure timely and accurate completion
          </li>
        </ul>
      </div>
      <div className="card mb-1">
      ...
      <div className="card mb-1">
        ...
        <ul className="list-group list-group-flush">
          <li className="list-group-item">
            Lead analyst on team working on large-scale, complex, and sensitive
            client relationship
          </li>
          <li className="list-group-item">
      ...
      <div className="card mb-1">
        <h6 className="card-title">Analyst - Institutional Fund Accounting</h6>
